...
\hypersetup{pdftitle={Методы и средства защиты информации}, pdfauthor={В. С. Верхотуров}, colorlinks=false, pdfborder={0 0 0}}
...
\begin{filecontents*}[overwrite]{biblio.bib}
    @book{bib:gostnir,
        year = 2017,
        title = {ГОСТ 7.32-2017. [Электронный ресурс] Межгосударственный стандарт. Система стандартов по информации, библиотечному и издательскому делу. Отчет о научно-исследовательской работе. Структура и правила оформления (введен в действие Приказом Росстандарта от 24.10.2017 \textnumero{}~1494-ст)},
        url = {http://www.consultant.ru/document/cons_doc_LAW_292293/e0e69dbfc914544530fc48e0bff33ea33d45d609/},
        urldate = {2022-06-18}
    }
    @online{bib:symbol,
